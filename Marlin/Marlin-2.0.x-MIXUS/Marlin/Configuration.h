...
#define STRING_CONFIG_H_AUTHOR "Raphaël Cloutier - Project MixUs Team #3 - Université de Sherbrooke - 2021" // Who made the changes.
...
#define Z_HOMING_HEIGHT 0.5 // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
